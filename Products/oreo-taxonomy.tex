...
strikingly similar genus \textbf{\emph{Auparoparo gen. nov.}} from the
indigenous Papuan language Motu. Their geographic distributions
implicate plate tectonic activity in diversification, with
...
satellite islands where there is range overlap. As evidenced by this
case, groups with unrecognized polyphyly are still in use today, so we
urge careful confirmation of monophyly for a nomenclature based on
evolution that will promote sound evolutionary research.
...
were required to reveal that this morphologically united group contains
...
\begin{longtable}[c]{|p{0.88in}|p{1.86in}|p{2.36in}|p{1.36in}}
...
that a 10-partition scheme involving locus and codon models with merged
partitions was superior by the Akaike Information Criterion (models by
partition included in Supplementary -Materials). Nodal support values
for the ML tree were inferred using 2000 bootstrap replicates.
...
For our subfamily-level phylogeny, the best evolutionary model was a 10
...
of partitions and models had an improvement of fit by 159 AIC units over
the 15-partition (locus by codon) model, 3686 AIC units better than the
5 partition locus-only model, and 4167 AIC units improvement over the 3
partition codon-only model. All phylogenetic reconstructions reported
here used the 10-partition scheme identified as best-fit by IQTREE2.
...
\textbf{Allison R. Fisher} (Conceptualization, Methodology, Analysis,
Writing, Reviewing, and Editing), \textbf{Ke Cao} (Data Collecting,
Analysis, Writing, Editing), \textbf{Allen Allison} (Conceptualization,
Writing, Reviewing, and Editing), \textbf{Bulisa Iova} (Collections,
Land Access, Writing), and \textbf{Marguerite A. Butler}
(Conceptualization, Analysis, Visualization, Supervision, Writing,
Editing)
