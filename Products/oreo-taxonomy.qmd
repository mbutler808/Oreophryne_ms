...
For our subfamily-level phylogeny, the best evolutionary model was a 10 partition scheme including a combination of locus by codon partitions (see Supplementary Table 1 for list of models). The best model had an improvement of fit by 159 AIC units over the 15-partition (locus by codon) model, 3686 AIC units better than the 5 partition locus-only model, and 4167 AIC units improvement over the 3 partition codon-only model. All phylogenetic reconstructions reported here used the 10-partition scheme identified as best-fit by IQTREE2.
