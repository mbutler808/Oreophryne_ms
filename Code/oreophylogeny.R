################################################################
# oreophylogeny.R 
# Processes output from IQTREE2 and metadata, plots figure 2 - the phylogeny
# 1. Read in tree and metadata
# 2. Clean tree labels 
# 3. Trim tree down to 1 species per site  (leave in all Oreophryne senkenbergiana)
# 4. Plot validation trees to check steps
# 5. Plot final tree with Oreophryne, type species, and Auparoparo highlighted
################################################################
## ---- packages --------
...
p
print_output("../Products/Validation_Figures/FullIQTree", p) 
...
p
print_output("../Products/Validation_Figures/TrimmedIQTree", p) 
...
print_output("../Products/Validation_Figures/FullTree_support", p_support) 
print_output("../Products/Manuscript/Figures/fig2.FullTree_support_highlight", gradient_tree(p_support)) 
