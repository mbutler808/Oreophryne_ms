...
pointmap <- basemap + 
	...
	# scale_shape_manual(values = c("Auparoparo" = 1, "Oreophryne" = 24)) +
	# scale_size_manual(values = c("Auparoparo" = 3, "Oreophryne" = 2.5)) +
	scale_color_manual(values = c("Auparoparo" = "white", "Oreophryne" = "white")) +
	scale_fill_manual(values = c("Auparoparo" = "red","Oreophryne" = "#0059FF")) +
	scale_shape_manual(values = c("Auparoparo" = 21, "Oreophryne" = 24)) +
	scale_size_manual(values = c("Auparoparo" = 1.75, "Oreophryne" = 2.5)) +
#	scale_color_manual(values = c("Auparoparo" = "red", "Oreophryne" = "white")) +
#	scale_fill_manual(values = c("Auparoparo" = NA,"Oreophryne" = "#0059FF")) +
...
## ---- plotmap --------
print(annotated)
print(inset, vp = viewport(0.72, 0.78, width = 0.55, height = 0.4))  
